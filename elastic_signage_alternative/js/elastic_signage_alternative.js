jQuery(document).ready(function($) {
	...
	function changeFont() {
		...
		if ($curWidth > $curHeight) { // Landscape
            ...
            $('div#events').insertAfter('div#slide');
            $('div#weather').insertAfter('div#slide');
            $('div#headline').appendTo('div#footer');
			...
			$weHeight = $imgHeight * 0.7;
 			$headlineHeight = $imgHeight * 0.25;
 			$hfHeight = ($curHeight - (($imgHeight * 2) + $weHeight)) / 2;
            $wHeight = ($imgWidth * 0.5) * 9/16;
            $footerHeight = $curHeight - ($hfHeight + ($imgHeight * 2) + $headlineHeight);
            $('div#datetime').insertAfter('div#weather-content');
            
            $('div#events').appendTo('div#footer');
            $('div#weather').appendTo('div#footer');
            $('div#headline').insertAfter('div#slide');
            ...
            $styleText += "#events{font-size:0.45em; width:50%; height:" + $weHeight + "px;} ";
            $styleText += "#eventTicker ul{width:100%;} ";
            ...
            $styleText += ".date-time-clock{font-size:0.85em;} ";
            ...
            $styleText += "#datetime-content{bottom:1.6em; right:1.5em; font-size:0.9em;} ";
